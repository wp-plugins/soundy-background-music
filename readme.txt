...
Tags: audio, sound, music, background, sound track, background sound, background audio, background music
...
2. Is Soundy Plugin compatible with iphone, ipad and smartphones in general? 

Yes, it is as the plugin uses the HTML5 audio tag.

3. Is it possible to position the Play/Pause button anywhere in the page or post header ?

Yes, this can be done with the soundy_button() template tag.

4. Is it possible to position the Play/Pause button anywhere in the content of a page or post ?

Yes, this can be done with the [soundy button] shortcode.

5. Is it possible to modify the Play/Pause button look & feel ?
